                                ...
                                if ($start) {
                                        ...
                                        if ($instance['State']['Code'] == 16) {
                                                ...
                                                foreach ($tagArray as $currentTag) {
                                                        #echo "\tCURRENT TAG object\n";
                                                        #print_r($currentTag);
                                                        if ($currentTag['Key'] == "Environment"){
                                                                #echo "ENVIRONMENT TAG Found!!\n";
                                                                #echo "\tEC2 Instance " . $instance['InstanceId'] . " is TAGGED\n";
                                                                $isTagged = true;
                                                        } else {
                                                                #echo "NO ENVIRONMENT TAG for this instance\n";
                                                                #echo "\tEC2 Instance " . $instance['InstanceId'] . " is UNTAGGED\n";
                                                                #array_push($instanceIds, $instance['InstanceId']);
                                                        }
                                                }
                                                echo "\tIdentified instance " . $instance['InstanceId'] . "\n";
